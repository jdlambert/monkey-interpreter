use crate::ast::{Statement, Program, Expression};
...
mod tests {
  ...
  fn test_let_statements() {
    ...
    assert_eq!(program.statements, vec![
      Statement::Let(Expression::Identifier("x".to_string()),
                     Expression::IntLiteral(5)),
      Statement::Let(Expression::Identifier("y".to_string()),
                     Expression::IntLiteral(10)),
      Statement::Let(Expression::Identifier("foobar".to_string()),
